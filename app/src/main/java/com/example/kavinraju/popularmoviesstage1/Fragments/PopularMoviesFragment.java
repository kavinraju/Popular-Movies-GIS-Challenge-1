package com.example.kavinraju.popularmoviesstage1.Fragments;
...
import com.example.kavinraju.popularmoviesstage1.Adapter.MovieListAdapter_HomeActivity;
...
import com.example.kavinraju.popularmoviesstage1.MovieDetailsActivity;
...
public class PopularMoviesFragment extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<MovieDetail>> ,
    ...
    private boolean defaultLoading = true;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mTextView = rootView.findViewById(R.id.textView_connection_failed);
        mImageView = rootView.findViewById(R.id.imageView_connention_failed);
        mProgressBar = rootView.findViewById(R.id.progressBar_fragment);
        mButton_retry = rootView.findViewById(R.id.button_networkRetry);
        ...
        //Log.d("onCreateView " ,currentSelectedbottomNavigation);
    ...
    public void onMovieTitleClick(View view, int clickedMoviePosition) {
        ...
        switch (view.getId()){
            ...
            case R.id.imageView_favorite_recycerView_Card_HomeActivity:
                ...
                ImageView imageView_fav = (ImageView)view;
                imageView_fav.setBackgroundResource(R.drawable.favorite_primary_24dp);
                break;
        }
    }
